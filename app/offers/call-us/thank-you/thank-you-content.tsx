    ...
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <section style={styles.thankYouSection} aria-labelledby="thank-you-heading">
          <h1 id="thank-you-heading" style={styles.thankYouTitle}>{t.thankYouTitle}</h1>
          <p style={styles.thankYouText}>{t.thankYouReceived}</p>
          <p style={styles.thankYouText}>{t.thankYouFollowUp}</p>
        </section>
